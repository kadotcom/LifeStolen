    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(sender instanceof Player){
            ...
            if(p.isOp() || p.hasPermission("lifestolen.lsgive") || p.hasPermission(plugin.getConfig().getString("permissions.permissionToDoEverything"))){
                if(args == null || args[0] == null || args[1] == null || args[2] == null || args[0].isEmpty() || args[0].isBlank() || args[0].length() == 0 || args[1].isEmpty() || args[1].isBlank() || args[1].length() == 0 || args[2].isEmpty() || args[2].isBlank() || args[2].length() == 0){
